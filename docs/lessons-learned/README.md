...
| [flex-on-summary-hides-webview2-disclosure.md](flex-on-summary-hides-webview2-disclosure.md) | `summary { display: flex }` can hide a collapsed disclosure in Tauri/WebView2 | 2026-09-08 |
