...
- **Weekly reviews & reports** — `planning-reports` crate for domain-blind Markdown files; app-owned summary region with preservation contract; `WeeklySummary` computed fresh on every open; Weekly Review use cases with prior-report read and next-week focus ensure; Tauri commands and TypeScript mirror. See [`docs/architecture/weekly-reports.md`](../architecture/weekly-reports.md) and [`docs/flows/opening-a-weekly-review.md`](../flows/opening-a-weekly-review.md). Plan: [`docs/plans/0006-weekly-review-and-reports.md`](../plans/0006-weekly-review-and-reports.md) (Task 8 verification pending).

## Next

- Plan 0007: UI surfaces (Daily Plan window, Library, Weekly Review window).
- Plan 0008: Launcher.
